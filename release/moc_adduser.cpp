...
QT_MOC_LITERAL(1, 8, 18), // "sig_submitUserData"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 18), // "VariableSet::User&"
QT_MOC_LITERAL(4, 47, 8), // "userinfo"
QT_MOC_LITERAL(5, 56, 20), // "on_btn_reset_clicked"
QT_MOC_LITERAL(6, 77, 21) // "on_btn_submit_clicked"

    },
    "AddUser\0sig_submitUserData\0\0"
    "VariableSet::User&\0userinfo\0"
    "on_btn_reset_clicked\0on_btn_submit_clicked"
};
...
void AddUser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_submitUserData((*reinterpret_cast< VariableSet::User(*)>(_a[1]))); break;
        ...
        {
            typedef void (AddUser::*_t)(VariableSet::User & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddUser::sig_submitUserData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddUser::sig_submitUserData(VariableSet::User & _t1)
{
